...
- [ ] [클라이언트–서버 구조 이해 및 요청 흐름 정리](A_시스템_기본_구조/클라이언트_서버_구조.md)
- [ ] [Sync vs Async 처리 모델 비교](A_시스템_기본_구조/Sync_Async_처리모델.md)
- [ ] [Blocking / Non-blocking I/O 차이와 적용 사례](A_시스템_기본_구조/Blocking_Nonblocking_IO.md)
- [ ] [웹 요청 생명주기(브라우저 → 서버 → 응답) 정리](A_시스템_기본_구조/웹_요청_생명주기.md)
- [ ] [TCP / HTTP 기본 구조 및 헤더 핵심 정리](A_시스템_기본_구조/TCP_HTTP_기본.md)
- [ ] [로드 밸런싱 개념과 L4/L7 비교](A_시스템_기본_구조/로드_밸런싱_L4_L7.md)
- [ ] [확장성·가용성·일관성·내구성·성능·보안 원칙 점검](A_시스템_기본_구조/시스템_품질_원칙.md)
- [ ] [모놀리식·MSA·이벤트 기반·CQRS·Gateway·Service Mesh 비교](A_시스템_기본_구조/아키텍처_패턴_비교.md)
